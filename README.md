...
## Docker Image
```
docker pull muaeabudhabi/code-server-test:latest
```

## Install on Unraid
1. Download `unraid-templates/my-code-server-test.xml`
2. Copy to `/boot/config/plugins/dockerMan/templates-user/`
3. Docker tab → Add Container → select `code-server-test`
